...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    startOverride, endOverride) {
        // console.log(defaultDisplayEventTime);
        // console.log(context);
        // console.log(seg);
            ...
            return buttonGroupStr.split(',').map(function (buttonName) {
                if (buttonName === 'title') {
                    ...
                    if ((customButtonProps_1 = calendarCustomButtons[buttonName])) {
                        ...
                        //console.log(viewSpecs[buttonName]);
    ...
    */
    ...
    var TableDateCell = /** @class */ (function (_super) {
        ...
        TableDateCell.prototype.render = function () {
            ...
            var text = dateEnv.format(date, props.dayHeaderFormat); // 주간달력시 상단 날짜 및 요일 텍스트
            ...
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.dayHeaderClassNames, content: options.dayHeaderContent, defaultContent: renderInner, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount }, function (rootElRef, customClassNames, innerElRef, innerContent) {
                ...
                createElement("div", { className: 'fc-scrollgrid-sync-inner' }, !dayMeta.isDisabled &&
                    ...
                    createElement("span", { className: 'week-rumi-lunarset' },
                        createElement("span", { className: 'week-rumi-lunarday' }, props.lunar.day),
                        props.lunar.holiday ? createElement("span", { className: 'week-rumi-lunarholiday' }, props.lunar.holiday) : "" ),
                    ))); }));
        };
            ...
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.dayHeaderClassNames, content: options.dayHeaderContent, defaultContent: renderInner, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount }, function (rootElRef, customClassNames, innerElRef, innerContent) {
                ...
                createElement("div", { className: 'fc-scrollgrid-sync-inner' },
                    createElement("a", { className: [
                            'fc-col-header-cell-cushion rumi',
        ...
        DayHeader.prototype.render = function () {
            ...
            return (createElement(NowTimer, { unit: 'day' }, function (nowDate, todayRange) { return (createElement("tr", null,
                ...
                dates.map(function (date) {
                    lunararr = date.lunardate;
                    date = date.date;
                    //lunararr = date.lunardate;
                    return (datesRepDistinctDays ?
                    createElement(TableDateCell, { key: date.toISOString(), lunar:lunararr, date: date, dateProfile: dateProfile, todayRange: todayRange, colCnt: dates.length, dayHeaderFormat: dayHeaderFormat }) :
    ...
    var DaySeriesModel = /** @class */ (function () {
        function DaySeriesModel(range, dateProfileGenerator) {
            ...
            var startDate = range.start; // 달력시작일자
            var endDate = range.end; // 달력종료일자
            this.lunar = get_lunar_db(startDate, endDate); // 음력, 공휴일 정보 가져오기
    ...
    var DayTableModel = /** @class */ (function () {
        function DayTableModel(daySeries, breakOnWeeks) {
            ...
            this.lunar = this.daySeries.lunar;
        }
        ...
        DayTableModel.prototype.buildCell = function (row, col) {
            ...
            var lundate = this.daySeries.lunar[row * this.colCnt + col];
            return {
        ...
        DayTableModel.prototype.buildHeaderDates = function () {
            var dates = [];
            for (var col = 0; col < this.colCnt; col++) {
                var lundate = this.daySeries.lunar[col];
                //dates.push(this.cells[0][col].date);
                dates[col] = {
                    date : this.cells[0][col].date,
                    lunardate : lundate
                };
                // lunardate : this.daySeries.lunar[col].date,
                // lunarholiday : this.daySeries.lunar[col].holiday
            }
            return dates;
        };
    ...
    */
    ...
    var EventResizing = /** @class */ (function (_super) {
        ...
        function EventResizing(settings) {
            ...
            _this.handleDragStart = function (ev) {  // 드래그 시작시
                var context = _this.component.context;
                var eventRange = _this.eventRange;
    ...
    */
        ...
        TableCell.prototype.render = function () {
            ...
            return (createElement(DayCellRoot, { date: date, dateProfile: dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, elRef: this.handleRootEl }, function (rootElRef, classNames, rootDataAttrs, isDisabled) { return (createElement("td", __assign({ ref: rootElRef, className: ['fc-daygrid-day'].concat(classNames, props.extraClassNames || []).join(' ') }, rootDataAttrs, props.extraDataAttrs),
                createElement("div", { className: 'fc-daygrid-day-frame fc-scrollgrid-sync-inner', ref: props.innerElRef /* different from hook system! RENAME */ },
                    ...
                    !isDisabled &&
                        createElement(TableCellTop, { lunar:props.lunar, date: date, dateProfile: dateProfile, showDayNumber: props.showDayNumber, todayRange: props.todayRange, extraHookProps: props.extraHookProps }),
    ...
    var TableCellTop = /** @class */ (function (_super) {
        ...
        TableCellTop.prototype.render = function () {
            var props = this.props;
            var toDay = this.context.options.initialDate; // 오늘날짜
            var lunar = this.props.lunar; // 음력 및 공휴일
            var navLinkAttrs = this.context.options.navLinks ? { 'data-navlink': buildNavLinkData(props.date), tabIndex: 0 } : {};
            // 221109 성재민, 날짜 "ㅁㅁ일 에서 일 제거하기 위해 오늘날짜를 따로 구한 후에 변수로 반영 하였습니다."
            var fixedToday = Number([String(props.date).split(" ")][0][2])
            ...
            return (createElement(DayCellContent, { date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, defaultContent: renderTopInner }, function (innerElRef, innerContent) {
                ...
                createElement("div", { className: 'fc-daygrid-day-top', ref: innerElRef },
                   (props.date >= toDay) && createElement("i", __assign({ className: 'fa fa-pencil rumi-write' }, navLinkAttrs)),
                    createElement("div", __assign({ className: 'rumi-lunarday' }), lunar.day),
                    lunar.holiday ? createElement("div", __assign({ className: 'rumi-lunarholiday' }), lunar.holiday) : "",
            // 221109 성재민, 생성한 변수를 아랫줄에 fixedToday로 집어넣었습니다. 원래는 innerContent입니다.
                            createElement("a", __assign({ className: 'fc-daygrid-day-number' }, navLinkAttrs), fixedToday))); }));
        };
        return TableCellTop;
    }(BaseComponent));
            ...
            if (framePositions) {
                for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
                   ...
                   nodes.push(createElement("div", { className: 'fc-daygrid-event-harness' + (isAbsolute ? ' fc-daygrid-event-harness-abs' : ''), key: instanceId, ref: isMirror ? null : this.segHarnessRefs.createRef(instanceId + ':' + seg.firstCol) /* in print mode when in mult cols, could collide */, style: {
                    ...
                    /* 일정이 1일(24시간 미만)이면 목록으로 표시, 24시간 이상이면 바 형태로 변경 */
                    // nodes.push(createElement("div", { className: 'fc-daygrid-event-harness' + (isAbsolute ? ' fc-daygrid-event-harness-abs' : ''), key: instanceId, ref: isMirror ? null : this.segHarnessRefs.createRef(instanceId + ':' + seg.firstCol) /* in print mode when in mult cols, could collide */, style: {
                    //         visibility: isInvisible ? 'hidden' : '',
                    //         marginTop: marginTop || '',
                    //         top: top_1 || '',
    ...
    var DayTableView = /** @class */ (function (_super) {
        ...
        DayTableView.prototype.render = function () {
            ...
            var headerContent = options.dayHeaders &&
                createElement(DayHeader, { lunar:dayTableModel.lunar, ref: this.headerRef, dateProfile: props.dateProfile, dates: dayTableModel.headerDates, datesRepDistinctDays: dayTableModel.rowCnt === 1 });
