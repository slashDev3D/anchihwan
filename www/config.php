...
// 221102 성재민 add publish folder directory 
define('G5_PUBLISH_DIR',    'publish');
define('G5_PUBLISH_URL',     G5_URL.'/'.G5_PUBLISH_DIR);
//==============================================================================
...
// 모바일 홈페이지를 사용하지 않을 경우 false 로 설정
// 221102 성재민 모바일 사용 안하므로 추가.
