...
<div id="hd" class="headerComponents">
    ...
    <div id="hd_wrapper" class="header--wrap">
        <div id="logo" class="header--logo"><a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/head_logo.png" alt="<?php echo $config['cf_title']; ?>"></a></div>
        <nav id="gnb">
            <div class="gnb_wrap">
            <ul id="gnb_1dul">
