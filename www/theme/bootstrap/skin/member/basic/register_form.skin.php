...
<div class="form-join">
	...
	<div class="form-group">
		...
		<small class="form-text text-muted">영문자, 숫자, _ 만 입력 가능. 최소 3자이상</small>
	</div>
	...
	<div class="form-group">
		...
		<label for="reg_mb_nick">닉네임</label>
			...
			<small class="form-text text-muted">공백없이 한글,영문,숫자만 입력 가능<br>닉네임 변경시 <?php echo (int)$config['cf_nick_modify'] ?>일 간 변경할 수 없습니다.</small>
		<?php }  ?>
	</div>
	...
	<div class="form-group">
		...
		<input class="form-control" type="file" name="mb_icon" id="reg_mb_icon">

		<small class="form-text text-muted">
			이미지 크기는 가로 <?php echo $config['cf_member_icon_width'] ?>픽셀, 세로 <?php echo $config['cf_member_icon_height'] ?>픽셀 이하<br>
			gif, jpg, png파일만 가능, 용량은 <?php echo number_format($config['cf_member_icon_size']) ?>바이트 이하
		</small>
	...
	<div class="form-group">
		...
		<!--
		<input class="form-control" type="file" name="mb_img" id="reg_mb_img" >
		-->
		<div class="custom-file">
			<input type="file" class="custom-file-input" name="mb_img" id="reg_mb_img">
			<label class="custom-file-label" for="reg_mb_img">파일을 선택해주세요.</label>
		</div>
	...
	<div class="form-group">
		...
		<div class="custom-control custom-checkbox">
			<input class="custom-control-input" type="checkbox" name="mb_mailling" value="1" id="reg_mb_mailling" <?php echo ($w=='' || $member['mb_mailling'])?'checked':''; ?>>
			<label class="custom-control-label" for="reg_mb_mailling">정보 메일을 받겠습니다.</label>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="custom-control custom-checkbox">
			<input class="custom-control-input" type="checkbox" name="mb_sms" value="1" id="reg_mb_sms" <?php echo ($w=='' || $member['mb_sms'])?'checked':''; ?>>
			<label class="custom-control-label" for="reg_mb_sms">휴대폰 문자메세지를 받겠습니다.</label>
		</div>
	</div>
	<?php }  ?>
	...
	<div class="form-group">
		...
		<div class="custom-control custom-checkbox">
			<input class="custom-control-input" type="checkbox" name="mb_open" value="1" <?php echo ($w=='' || $member['mb_open'])?'checked':''; ?> id="reg_mb_open">

			<label class="custom-control-label" for="reg_mb_open">나의 정보를 공개합니다.</label>
		</div>
		<?php if($config['cf_open_modify']>0) { ?>
		<small class="form-text text-muted">정보공개는 <?php echo (int)$config['cf_open_modify'] ?>일 이내 변경불가</small>
		<?php } ?>
	</div>
	<?php } else {  ?>
	<div class="form-group">
	...
	<input type="submit" value="<?php echo $w==''?'회원가입':'정보수정'; ?>" id="btn_submit" class="btn btn-primary btn-block" accesskey="s">
</form>
</div>
