...
add_stylesheet('<style>.sns-icon-not { -webkit-filter: grayscale(100%); filter: grayscale(100%); }</style>');
?>

<div class="form-group">
	<label>SNS 로그인 관리</label>
	<div class="sns-wrap">
		...
		<a href="<?php echo $link_href; ?>" id="sns-<?php echo $social; ?>" class="social_link sns-<?php echo $social; ?><?php echo $add_class; ?>" title="<?php echo $title; ?>" data-provider="<?php echo $social; ?>"><img src="<?php echo get_social_skin_url().'/img/sns_'.$social.'_s.png' ?>"></a>
