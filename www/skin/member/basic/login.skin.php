...
add_stylesheet('<link rel="stylesheet" href="'.G5_PUBLISH_URL.'/css/login.css">', 2);
?>
...
<div id="mb_login" class="mbskin">
    ...
    <div class="mbskin_box">
        ...
        <h2 class="font-special login--title"><img style="width:180px;display:block;margin:0 auto 40px;" src="/img/ach_logo_b.png" alt=""></h2>
        ...
        <fieldset id="login_fs">
            ...
            <input type="text" name="mb_id" id="login_id" required class="frm_input required" size="20" maxLength="20" placeholder="아이디 입력">
            <label for="login_pw" class="sound_only">비밀번호<strong class="sound_only"> 필수</strong></label>
            <input type="password" name="mb_password" id="login_pw" required class="frm_input required" size="20" maxLength="20" placeholder="비밀번호 입력">
            
            <div id="login_info">
                <div class="login_if_auto chk_box">
                    <input type="checkbox" name="auto_login" id="login_auto_login" class="selec_chk">
                    <label for="login_auto_login"><span></span> 아이디 저장</label>  
                </div>
            ...
            <div class="login--links">
                <div class="login--linkItem"><a href="<?php echo G5_BBS_URL ?>/register.php" class="join">회원가입</a></div>
                <span class="login--linkItem-line"></span>
                <div class="login--linkItem"><a href="<?php echo G5_BBS_URL ?>/password_lost.php">아이디/비밀번호 찾기</a> </div>
            </div>
        </fieldset> 
        </form>
