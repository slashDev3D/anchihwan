...
add_stylesheet('<link rel="stylesheet" href="'.G5_PUBLISH_URL.'/css/register.css">', 0);
...
<div class="register<? if($is_member)echo ' register_modify'; ?>">
	    ...
	    <div class="register_form_inner">
	        ...
	        <ul>
	            <li>
                    ...
                    <div class="register_input_id">
                        <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?> <?php echo $readonly ?> class="frm_input full_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" placeholder="7~15자의 영문 및 숫자 조합">
                        <span id="msg_mb_id"></span>
                        <button onclick="idCheck()" class="register--btn_frmline">중복확인</button>
                    </div>
	            </li>
	            <li class=" margin_input">
	                <label for="reg_mb_password">비밀번호 (필수)</label>
	                <input type="password" name="mb_password" id="reg_mb_password" <?php echo $required ?> class="frm_input full_input <?php echo $required ?>" minlength="3" maxlength="20" placeholder="6자리 이상의 영문 혹은 숫자">
	            </li>
	            <li class="">
	            ...
	            <li>
                    ...
                    <input type="text" name="mb_nick" value="<?php echo isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>" id="reg_mb_nick" required class="frm_input required nospace full_input" size="10" maxlength="20" placeholder="10자 이내 영문, 한글, 숫자">
	            ...
	            <?php if ($config['cf_use_tel']) {  ?>
	                ...
	                <input type="text" name="mb_tel" value="<?php echo get_text($member['mb_tel']) ?>" id="reg_mb_tel" <?php echo $config['cf_req_tel']?"required":""; ?> class="frm_input full_input <?php echo $config['cf_req_tel']?"required":""; ?>" maxlength="20" placeholder="숫자로만 입력">
	            <?php }  ?>
				</li>
				<li>
