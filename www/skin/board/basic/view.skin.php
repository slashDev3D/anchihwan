...
<!-- 게시물 읽기 시작 { -->
    ...
    <div class="board--view-info">
        <div class="board--view-infoWrap">
            <div class="board--view-name"><? echo $view['name'] ?></div>
            <span class="board--view-info-line"></span>
            <div class="board--view-date"><? echo date("y-m-d", strtotime($view['wr_datetime']))?></div>
            <span class="board--view-info-line"></span>
            <div class="board--view-view"><span class="material-symbols-outlined">visibility</span><? echo number_format($view['wr_hit']) ?></div>
        </div>
    </div>
    ...
    <?php if ($prev_href || $next_href) { ?>
        <ul class="bo_v_nb">
            <?php if ($prev_href) { ?><li class="btn_prv"><span class="material-symbols-outlined">expand_less</span><a href="<?php echo $prev_href ?>"><?php echo $prev_wr_subject;?></a> <span class="nb_date"><?php echo str_replace('-', '.', substr($prev_wr_date, '2', '8')); ?></span></li><?php } ?>
            <?php if ($next_href) { ?><li class="btn_next"><span class="material-symbols-outlined">expand_more</span><a href="<?php echo $next_href ?>"><?php echo $next_wr_subject;?></a>  <span class="nb_date"><?php echo str_replace('-', '.', substr($next_wr_date, '2', '8')); ?></span></li><?php } ?>
        </ul>
    <?php } ?>
    <div class="board--toList-btn"><a href="<?php echo $list_href ?>">목록</a></div>
<!-- } 게시판 읽기 끝 -->
</div>
<script>
