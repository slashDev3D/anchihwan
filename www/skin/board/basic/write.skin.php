...
add_stylesheet('<link rel="stylesheet" href="'.G5_PUBLISH_URL.'/css/bo_free.css">', 2);
?>

<section id="bo_w" pa>
<div class="board--write-container">
    <h2 class="sound_only"><?php echo $g5['title'] ?></h2>
    <div class="board--write-boardTitle">
    <?php echo $g5['title'] ?>
    </div>
    <!-- 게시물 작성/수정 시작 { -->
    ...
    <div class="board--write-file">
    <?php for ($i=0; $is_file && $i<$file_count; $i++) { ?>
        <div class="bo_w_flie write_div">
            <div class="file_wr write_div">
                <label for="bf_file_<?php echo $i+1 ?>" class="lb_icon"><span class="material-symbols-outlined">folder_open</span><span class="sound_only"> 파일 #<?php echo $i+1 ?></span></label>
    ...
    <div class="btn_confirm write_div">
        <button type="submit" id="btn_submit" accesskey="s" class="btn_submit btn">등록</button>
