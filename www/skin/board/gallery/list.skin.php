...
add_stylesheet('<link rel="stylesheet" href="'.G5_PUBLISH_URL.'/css/bo_gallery.css">', 0);
?>
            ...
            <li class="bo_gallery_item">
                <div class="gall_box">
                    <div class="gall_con">
                        ...
                        <div class="gall_img">
                            <!-- <a href="<?php// echo $list[$i]['href'] ?>" style="background-image:url(<? //echo $img ?>)"> -->
                            ...
                            <?php } else { ?>
                                ...
                                <?if($thumb['src']) { ?>
                                    <a href="<?php echo $list[$i]['href'] ?>" style="background-image:url(<? echo $thumb['src'] ?>)">
