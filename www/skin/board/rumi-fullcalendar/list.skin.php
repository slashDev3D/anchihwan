...
add_stylesheet('<link rel="stylesheet" href="'.G5_PUBLISH_URL.'/css/bo_rumi.css">', 2);
...
add_javascript('<script src="'.G5_PUBLISH_URL.'/js/bo_rumi.js"></script>', 2);
?>
<div class="calendar--top">
    <a href="http://anchihwan.com/bbs/board.php?bo_table=calendar">TODAY</a>
</div>
